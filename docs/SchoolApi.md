...
|------------- | ------------- | -------------|
| [**createConfiguration**](SchoolApi.md#createConfiguration) | **POST** /school | Create a new school configuration |
| [**getConfigurations**](SchoolApi.md#getConfigurations) | **GET** /school | Retrieve all school configurations |
| [**updateConfiguration**](SchoolApi.md#updateConfiguration) | **PUT** /school/{code} | Update a single school configuration |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SchoolApi#createConfiguration");
...
|------------- | ------------- | ------------- | -------------|
| **codeObject** | [**CodeObject**](CodeObject.md)| The school code to be written. | |
...
|-------------|-------------|------------------|
| **200** | The school provided has been created. |  -  |
| **401** | Unauthorized |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SchoolApi#getConfigurations");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SchoolApi#updateConfiguration");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
