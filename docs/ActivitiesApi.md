...
|------------- | ------------- | -------------|
| [**getAll**](ActivitiesApi.md#getAll) | **GET** /simpleschedule/activities | Obtains all activities. |


<a name="getAll"></a>
# **getAll**
> ResultDtoActivityDto getAll().execute();
...
[**ResultDtoActivityDto**](ResultDtoActivityDto.md)
