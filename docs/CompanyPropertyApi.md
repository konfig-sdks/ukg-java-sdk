...
|------------- | ------------- | -------------|
| [**createConfigurationUkgPro**](CompanyPropertyApi.md#createConfigurationUkgPro) | **POST** /companyProperty | Create a new companyProperty configuration |
| [**getConfigurations**](CompanyPropertyApi.md#getConfigurations) | **GET** /companyProperty | Retrieve all companyProperty configurations |
| [**updateConfiguration**](CompanyPropertyApi.md#updateConfiguration) | **PUT** /companyProperty/{code} | Update a single companyProperty configuration |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling CompanyPropertyApi#createConfigurationUkgPro");
...
|------------- | ------------- | ------------- | -------------|
| **codeObject** | [**CodeObject**](CodeObject.md)| The companyProperty code to be written. | |
...
|-------------|-------------|------------------|
| **200** | The companyProperty provided has been created. |  -  |
| **401** | Unauthorized |  -  |
...
Retrieve all companyProperty configurations
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling CompanyPropertyApi#getConfigurations");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling CompanyPropertyApi#updateConfiguration");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
