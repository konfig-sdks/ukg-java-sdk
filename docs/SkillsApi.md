...
|------------- | ------------- | -------------|
| [**createConfiguration**](SkillsApi.md#createConfiguration) | **POST** /skills | Create a new skills configuration |
| [**getConfigurations**](SkillsApi.md#getConfigurations) | **GET** /skills | Retrieve all skills configurations |
| [**updateConfiguration**](SkillsApi.md#updateConfiguration) | **PUT** /skills/{code} | Update a single skills configuration |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SkillsApi#createConfiguration");
...
|------------- | ------------- | ------------- | -------------|
| **codeObject** | [**CodeObject**](CodeObject.md)| The skills code to be written. | |
...
|-------------|-------------|------------------|
| **200** | The skills provided has been created. |  -  |
| **401** | Unauthorized |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SkillsApi#getConfigurations");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SkillsApi#updateConfiguration");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
