...
|------------- | ------------- | -------------|
| [**createConfigurationUkgPro**](MilitaryEraApi.md#createConfigurationUkgPro) | **POST** /militaryEra | Create a new militaryEra configuration |
| [**getConfigurations**](MilitaryEraApi.md#getConfigurations) | **GET** /militaryEra | Retrieve all militaryEra configurations |
| [**updateConfiguration**](MilitaryEraApi.md#updateConfiguration) | **PUT** /militaryEra/{code} | Update a single militaryEra configuration |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MilitaryEraApi#createConfigurationUkgPro");
...
|------------- | ------------- | ------------- | -------------|
| **codeObject** | [**CodeObject**](CodeObject.md)| The militaryEra code to be written. | |
...
|-------------|-------------|------------------|
| **200** | The militaryEra provided has been created. |  -  |
| **401** | Unauthorized |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MilitaryEraApi#getConfigurations");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MilitaryEraApi#updateConfiguration");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
