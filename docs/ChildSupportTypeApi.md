...
|------------- | ------------- | -------------|
| [**createConfigurationUkgPro**](ChildSupportTypeApi.md#createConfigurationUkgPro) | **POST** /childSupportType | Create a new childSupportType configuration |
| [**getConfigurations**](ChildSupportTypeApi.md#getConfigurations) | **GET** /childSupportType | Retrieve all childSupportType configurations |
| [**updateConfiguration**](ChildSupportTypeApi.md#updateConfiguration) | **PUT** /childSupportType/{code} | Update a single childSupportType configuration |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ChildSupportTypeApi#createConfigurationUkgPro");
...
|------------- | ------------- | ------------- | -------------|
| **codeObject** | [**CodeObject**](CodeObject.md)| The childSupportType code to be written. | |
...
|-------------|-------------|------------------|
| **200** | The childSupportType provided has been created. |  -  |
| **401** | Unauthorized |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ChildSupportTypeApi#getConfigurations");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ChildSupportTypeApi#updateConfiguration");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
