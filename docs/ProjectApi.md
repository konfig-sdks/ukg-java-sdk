...
|------------- | ------------- | -------------|
| [**createConfiguration**](ProjectApi.md#createConfiguration) | **POST** /project | Create a new project configuration |
| [**getAllConfigurations**](ProjectApi.md#getAllConfigurations) | **GET** /project | Retrieve all Project configurations |
| [**updateConfiguration**](ProjectApi.md#updateConfiguration) | **PUT** /project/{code} | Update a single project configuration |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ProjectApi#createConfiguration");
...
|------------- | ------------- | ------------- | -------------|
| **codeObject** | [**CodeObject**](CodeObject.md)| The project code to be written. | |
...
|-------------|-------------|------------------|
| **200** | The project provided has been created. |  -  |
| **401** | Unauthorized |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ProjectApi#getAllConfigurations");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ProjectApi#updateConfiguration");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
