...
|------------- | ------------- | -------------|
| [**createConfigurationUkgPro**](WaiveReasonApi.md#createConfigurationUkgPro) | **POST** /waiveReason | Create a new waiveReason configuration |
| [**getConfigurations**](WaiveReasonApi.md#getConfigurations) | **GET** /waiveReason | Retrieve all waiveReason configurations |
| [**updateSingleConfiguration**](WaiveReasonApi.md#updateSingleConfiguration) | **PUT** /waiveReason/{code} | Update a single waiveReason configuration |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling WaiveReasonApi#createConfigurationUkgPro");
...
|------------- | ------------- | ------------- | -------------|
| **codeObject** | [**CodeObject**](CodeObject.md)| The waiveReason code to be written. | |
...
|-------------|-------------|------------------|
| **200** | The waiveReason provided has been created. |  -  |
| **401** | Unauthorized |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling WaiveReasonApi#getConfigurations");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling WaiveReasonApi#updateSingleConfiguration");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
