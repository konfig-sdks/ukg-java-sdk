...
|------------- | ------------- | -------------|
| [**createConfigurationUkgPro**](DisabilityApi.md#createConfigurationUkgPro) | **POST** /disability | Create a new disability configuration |
| [**getConfigurations**](DisabilityApi.md#getConfigurations) | **GET** /disability | Retrieve all disability configurations |
| [**updateConfiguration**](DisabilityApi.md#updateConfiguration) | **PUT** /disability/{code} | Update a single disability configuration |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling DisabilityApi#createConfigurationUkgPro");
...
|------------- | ------------- | ------------- | -------------|
| **codeObject** | [**CodeObject**](CodeObject.md)| The disability code to be written. | |
...
|-------------|-------------|------------------|
| **200** | The disability provided has been created. |  -  |
| **401** | Unauthorized |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling DisabilityApi#getConfigurations");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling DisabilityApi#updateConfiguration");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
