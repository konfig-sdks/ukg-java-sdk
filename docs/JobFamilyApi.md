...
|------------- | ------------- | -------------|
| [**createConfiguration**](JobFamilyApi.md#createConfiguration) | **POST** /jobFamily | Create a new jobFamily configuration |
| [**getAllConfigurations**](JobFamilyApi.md#getAllConfigurations) | **GET** /jobFamily | Retrieve all jobFamily configurations |
| [**updateConfiguration**](JobFamilyApi.md#updateConfiguration) | **PUT** /jobFamily/{code} | Update a single jobFamily configuration |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling JobFamilyApi#createConfiguration");
...
|------------- | ------------- | ------------- | -------------|
| **codeObject** | [**CodeObject**](CodeObject.md)| The jobFamily code to be written. | |
...
|-------------|-------------|------------------|
| **200** | The jobFamily provided has been created. |  -  |
| **401** | Unauthorized |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling JobFamilyApi#getAllConfigurations");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling JobFamilyApi#updateConfiguration");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
