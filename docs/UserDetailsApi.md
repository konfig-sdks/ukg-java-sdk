...
|------------- | ------------- | -------------|
| [**getUserDetails**](UserDetailsApi.md#getUserDetails) | **GET** /personnel/v1/user-details | Get User Details |


<a name="getUserDetails"></a>
# **getUserDetails**
> List&lt;UserDetails&gt; getUserDetails().userName(userName).userStatus(userStatus).employeeId(employeeId).page(page).perPage(perPage).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer perPage = 56;
    try {
      List<UserDetails> result = client
              .userDetails
              .getUserDetails()
              .userName(userName)
      ...
      System.err.println("Exception when calling UserDetailsApi#getUserDetails");
    ...
    try {
      ApiResponse<List<UserDetails>> response = client
              .userDetails
              .getUserDetails()
              .userName(userName)
              .userStatus(userStatus)
