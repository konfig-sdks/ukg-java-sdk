...
/**
 * API tests for GetSpecificPtoPlanApi
 */
@Disabled
public class GetSpecificPtoPlanApiTest {

    private static GetSpecificPtoPlanApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new GetSpecificPtoPlanApi(apiClient);
    }
    ...
    public void infoTest() throws ApiException {
        ...
        String ptoPlan = null;
        List<PtoPlans> response = api.info(companyId, employeeId, ptoPlan)
                .execute();
