...
/**
 * API tests for KronosEmployeeStatusApi
 */
@Disabled
public class KronosEmployeeStatusApiTest {

    private static KronosEmployeeStatusApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new KronosEmployeeStatusApi(apiClient);
    }
    ...
    public void getTest() throws ApiException {
        ...
        Integer inactiveTermWindow = null;
        Integer inactiveDisabledWindow = null;
        Integer page = null;
        Integer perPage = null;
        List<EmployeeStatus> response = api.get()
