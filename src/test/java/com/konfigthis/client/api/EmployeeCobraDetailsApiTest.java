...
/**
 * API tests for EmployeeCobraDetailsApi
 */
@Disabled
public class EmployeeCobraDetailsApiTest {

    private static EmployeeCobraDetailsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmployeeCobraDetailsApi(apiClient);
    }
    ...
    public void getTest() throws ApiException {
        ...
        Boolean cobraIsActive = null;
        String cobraStatus = null;
        OffsetDateTime dateOfCobraEvent = null;
        Integer page = null;
        Integer perPage = null;
        List<EmployeeCobraDetails> response = api.get()
                .companyId(companyId)
