...
/**
 * API tests for MilitaryBranchesApi
 */
@Disabled
public class MilitaryBranchesApiTest {

    private static MilitaryBranchesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new MilitaryBranchesApi(apiClient);
    }
     ...
     */
    @Test
    public void configureUkgProTest() throws ApiException {
        String description = null;
        String code = null;
        api.configureUkgPro(description, code)
                .execute();
