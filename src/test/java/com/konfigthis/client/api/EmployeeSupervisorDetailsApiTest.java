...
/**
 * API tests for EmployeeSupervisorDetailsApi
 */
@Disabled
public class EmployeeSupervisorDetailsApiTest {

    private static EmployeeSupervisorDetailsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmployeeSupervisorDetailsApi(apiClient);
    }
    ...
    public void getTest() throws ApiException {
        ...
        String supervisorCompanyId = null;
        String supervisorEmployeeId = null;
        String supervisorCompanyCode = null;
        Integer page = null;
        Integer perPage = null;
        List<EmployeeSupervisorDetails> response = api.get()
                .companyId(companyId)
