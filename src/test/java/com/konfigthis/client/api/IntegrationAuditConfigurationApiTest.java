...
/**
 * API tests for IntegrationAuditConfigurationApi
 */
@Disabled
public class IntegrationAuditConfigurationApiTest {

    private static IntegrationAuditConfigurationApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new IntegrationAuditConfigurationApi(apiClient);
    }
    ...
    public void getDataTest() throws ApiException {
        ...
        List<IntegrationAuditConfiguration> response = api.getData()
                .tableName(tableName)
                .fieldName(fieldName)
                .page(page)
                .perPage(perPage)
