...
/**
 * API tests for ShiftCodeApi
 */
@Disabled
public class ShiftCodeApiTest {

    private static ShiftCodeApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ShiftCodeApi(apiClient);
    }
    ...
    public void getDataTest() throws ApiException {
        ...
        List<ShiftCodeGetList> response = api.getData()
                .page(page)
                .perPage(perPage)
                .execute();
