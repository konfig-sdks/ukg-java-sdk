...
/**
 * API tests for SkillProficiencyLevelApi
 */
@Disabled
public class SkillProficiencyLevelApiTest {

    private static SkillProficiencyLevelApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new SkillProficiencyLevelApi(apiClient);
    }
