...
/**
 * API tests for JobGroupApi
 */
@Disabled
public class JobGroupApiTest {

    private static JobGroupApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new JobGroupApi(apiClient);
    }
    ...
    public void getTest() throws ApiException {
        ...
        String jobGroupCountryCode = null;
        Integer page = null;
        Integer perPage = null;
        List<JobGroupDetail> response = api.get()
