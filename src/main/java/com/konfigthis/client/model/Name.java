...
import com.konfigthis.client.model.NamePrefix;
import com.konfigthis.client.model.NameSuffix;
...
public class Name {
  ...
  **/
  ...
  @ApiModelProperty(value = "The candidate’s first name. Maximum of 100 characters.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The candidate’s middle name. Maximum of 50 characters.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The candidate’s last name. Maximum of 100 characters.")
  ...
  public Name prefix(NamePrefix prefix) {
  ...
  **/
  ...
  public Name suffix(NameSuffix suffix) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(first, middle, last, prefix, suffix, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("prefix") != null && !jsonObj.get("prefix").isJsonNull()) {
        NamePrefix.validateJsonObject(jsonObj.getAsJsonObject("prefix"));
      }
      // validate the optional field `suffix`
      if (jsonObj.get("suffix") != null && !jsonObj.get("suffix").isJsonNull()) {
        NameSuffix.validateJsonObject(jsonObj.getAsJsonObject("suffix"));
      }
  }
