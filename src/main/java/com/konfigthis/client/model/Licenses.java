...
import com.konfigthis.client.model.LicensesLicense;
 ...
 */
@ApiModel(description = "An array containing candidate’s professional licenses and certifications.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Licenses {
  ...
  private LicensesLicense license;

  public static final String SERIALIZED_NAME_NUMBER = "number";
  @SerializedName(SERIALIZED_NAME_NUMBER)
  private String number;

  public static final String SERIALIZED_NAME_ACHIEVED_DATE = "achieved_date";
  @SerializedName(SERIALIZED_NAME_ACHIEVED_DATE)
  ...
  **/
  ...
  @ApiModelProperty(value = "The id of the candidate’s license record. ")
  ...
  public Licenses license(LicensesLicense license) {
  ...
  **/
  ...
  public LicensesLicense getLicense() {
    return license;
  }


  public void setLicense(LicensesLicense license) {
  ...
  public Licenses number(String number) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The license number. Max length of 20.")
  ...
  public Licenses achievedDate(String achievedDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the license was achieved. ")
  ...
  public Licenses renewalDate(String renewalDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the license was renewed.")
   ...
   * @return the Licenses instance itself
   */
  public Licenses putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, licenses.id) &&
        Objects.equals(this.license, licenses.license) &&
        Objects.equals(this.number, licenses.number) &&
        Objects.equals(this.achievedDate, licenses.achievedDate) &&
        Objects.equals(this.renewalDate, licenses.renewalDate)&&
        Objects.equals(this.additionalProperties, licenses.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, license, number, achievedDate, renewalDate, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("achieved_date");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("license") != null && !jsonObj.get("license").isJsonNull()) {
        LicensesLicense.validateJsonObject(jsonObj.getAsJsonObject("license"));
      }
      if ((jsonObj.get("number") != null && !jsonObj.get("number").isJsonNull()) && !jsonObj.get("number").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `number` to be a primitive type in the JSON string but got `%s`", jsonObj.get("number").toString()));
      }
      if ((jsonObj.get("achieved_date") != null && !jsonObj.get("achieved_date").isJsonNull()) && !jsonObj.get("achieved_date").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `achieved_date` to be a primitive type in the JSON string but got `%s`", jsonObj.get("achieved_date").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Licenses>() {
           ...
           public Licenses read(JsonReader in) throws IOException {
             ...
             Licenses instance = thisAdapter.fromJsonTree(jsonObj);
