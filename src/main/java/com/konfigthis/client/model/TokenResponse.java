...
public class TokenResponse {
  ...
  **/
  ...
  @ApiModelProperty(value = "This is an encrypted string, JWT token")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "When the token will expire, in seconds")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "the scope of what you are entitled to access, part of your integration setup")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessToken, tokenType, expiresIn, scope, additionalProperties);
  }
