...
public class OrgLevelsBodyInner {
  ...
  public OrgLevelsBodyInner() {
  }

  public OrgLevelsBodyInner description(String description) {
  ...
  **/
  ...
  public OrgLevelsBodyInner budgetGroup(String budgetGroup) {
  ...
  **/
  ...
  public OrgLevelsBodyInner code(String code) {
  ...
  **/
  ...
  public OrgLevelsBodyInner currentYearBudgetFTE(Double currentYearBudgetFTE) {
  ...
  **/
  ...
  public OrgLevelsBodyInner currentYearBudgetSalary(Double currentYearBudgetSalary) {
  ...
  **/
  ...
  public OrgLevelsBodyInner glSegment(String glSegment) {
  ...
  **/
  ...
  public OrgLevelsBodyInner lastYearBudgetFTE(Double lastYearBudgetFTE) {
  ...
  public OrgLevelsBodyInner lastYearBudgetFTE(Integer lastYearBudgetFTE) {
  ...
  **/
  ...
  public OrgLevelsBodyInner lastYearBudgetSalary(Double lastYearBudgetSalary) {
  ...
  public OrgLevelsBodyInner lastYearBudgetSalary(Integer lastYearBudgetSalary) {
  ...
  **/
  ...
  public OrgLevelsBodyInner level(Double level) {
  ...
  public OrgLevelsBodyInner level(Integer level) {
  ...
  **/
  ...
  public OrgLevelsBodyInner levelDescription(String levelDescription) {
  ...
  **/
  ...
  public OrgLevelsBodyInner reportingCategory(String reportingCategory) {
  ...
  **/
  ...
  public OrgLevelsBodyInner isActive(Boolean isActive) {
  ...
  **/
   ...
   * @return the OrgLevelsBodyInner instance itself
   */
  public OrgLevelsBodyInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrgLevelsBodyInner orgLevelsBodyInner = (OrgLevelsBodyInner) o;
    return Objects.equals(this.description, orgLevelsBodyInner.description) &&
        Objects.equals(this.budgetGroup, orgLevelsBodyInner.budgetGroup) &&
        Objects.equals(this.code, orgLevelsBodyInner.code) &&
        Objects.equals(this.currentYearBudgetFTE, orgLevelsBodyInner.currentYearBudgetFTE) &&
        Objects.equals(this.currentYearBudgetSalary, orgLevelsBodyInner.currentYearBudgetSalary) &&
        Objects.equals(this.glSegment, orgLevelsBodyInner.glSegment) &&
        Objects.equals(this.lastYearBudgetFTE, orgLevelsBodyInner.lastYearBudgetFTE) &&
        Objects.equals(this.lastYearBudgetSalary, orgLevelsBodyInner.lastYearBudgetSalary) &&
        Objects.equals(this.level, orgLevelsBodyInner.level) &&
        Objects.equals(this.levelDescription, orgLevelsBodyInner.levelDescription) &&
        Objects.equals(this.reportingCategory, orgLevelsBodyInner.reportingCategory) &&
        Objects.equals(this.isActive, orgLevelsBodyInner.isActive)&&
        Objects.equals(this.additionalProperties, orgLevelsBodyInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrgLevelsBodyInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrgLevelsBodyInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrgLevelsBodyInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrgLevelsBodyInner is not found in the empty JSON string", OrgLevelsBodyInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrgLevelsBodyInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrgLevelsBodyInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrgLevelsBodyInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrgLevelsBodyInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrgLevelsBodyInner.class));

       return (TypeAdapter<T>) new TypeAdapter<OrgLevelsBodyInner>() {
           @Override
           public void write(JsonWriter out, OrgLevelsBodyInner value) throws IOException {
           ...
           @Override
           public OrgLevelsBodyInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrgLevelsBodyInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrgLevelsBodyInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrgLevelsBodyInner
  * @throws IOException if the JSON string is invalid with respect to OrgLevelsBodyInner
  */
  public static OrgLevelsBodyInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrgLevelsBodyInner.class);
  }

 /**
  * Convert an instance of OrgLevelsBodyInner to an JSON string
  *
  * @return JSON string
  */
