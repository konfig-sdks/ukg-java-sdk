...
public class SchoolApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SchoolApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public SchoolApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    public class CreateConfigurationRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> The school provided has been created. </td><td>  -  </td></tr>
     ...
     * @param codeObject The school code to be written. (required)
    ...
    private okhttp3.Call updateConfigurationCall(String code, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/school/{code}"
