...
public class SkillsApiGenerated {
    ...
    public class CreateConfigurationRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> The skills provided has been created. </td><td>  -  </td></tr>
     ...
     * @param codeObject The skills code to be written. (required)
    ...
    private okhttp3.Call updateConfigurationCall(String code, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/skills/{code}"
