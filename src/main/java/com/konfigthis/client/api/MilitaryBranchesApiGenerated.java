...
public class MilitaryBranchesApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MilitaryBranchesApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public MilitaryBranchesApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call configureUkgProCall(CodeObject codeObject, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/militaryBranches";
    ...
    private okhttp3.Call configureUkgProValidateBeforeCall(CodeObject codeObject, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'codeObject' is set
        if (codeObject == null) {
            throw new ApiException("Missing the required parameter 'codeObject' when calling configureUkgPro(Async)");
        }

        return configureUkgProCall(codeObject, _callback);

    }


    private ApiResponse<Void> configureUkgProWithHttpInfo(CodeObject codeObject) throws ApiException {
        okhttp3.Call localVarCall = configureUkgProValidateBeforeCall(codeObject, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call configureUkgProAsync(CodeObject codeObject, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = configureUkgProValidateBeforeCall(codeObject, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class ConfigureUkgProRequestBuilder {
        private final String description;
        private final String code;

        private ConfigureUkgProRequestBuilder(String description, String code) {
            this.description = description;
            this.code = code;
        }

        /**
         * Build call for configureUkgPro
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> The militaryBranches provided has been created. </td><td>  -  </td></tr>
        ...
        /**
         * Execute configureUkgPro request
        ...
        public void execute() throws ApiException {
            CodeObject codeObject = buildBodyParams();
            configureUkgProWithHttpInfo(codeObject);
        }

        /**
         * Execute configureUkgPro request with HTTP info returned
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            CodeObject codeObject = buildBodyParams();
            return configureUkgProWithHttpInfo(codeObject);
        }

        /**
         * Execute configureUkgPro request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            CodeObject codeObject = buildBodyParams();
            return configureUkgProAsync(codeObject, _callback);
        }
    }
     ...
     * @param codeObject The militaryBranches code to be written. (required)
     * @return ConfigureUkgProRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The militaryBranches provided has been created. </td><td>  -  </td></tr>
     ...
     */
    public ConfigureUkgProRequestBuilder configureUkgPro(String description, String code) throws IllegalArgumentException {
        ...
        return new ConfigureUkgProRequestBuilder(description, code);
    }
    ...
    private okhttp3.Call updateConfigurationCall(String code, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/militaryBranches/{code}"
