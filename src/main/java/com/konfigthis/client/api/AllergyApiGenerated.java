...
public class AllergyApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AllergyApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public AllergyApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call configurationsGetCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call configurationsGetValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return configurationsGetCall(_callback);

    }


    private ApiResponse<List<CodeObject>> configurationsGetWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = configurationsGetValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<List<CodeObject>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call configurationsGetAsync(final ApiCallback<List<CodeObject>> _callback) throws ApiException {

        okhttp3.Call localVarCall = configurationsGetValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<List<CodeObject>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ConfigurationsGetRequestBuilder {

        private ConfigurationsGetRequestBuilder() {
        }
        ...
        /**
         * Execute configurationsGet request
        ...
        public List<CodeObject> execute() throws ApiException {
            ApiResponse<List<CodeObject>> localVarResp = configurationsGetWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute configurationsGet request with HTTP info returned
        ...
        public ApiResponse<List<CodeObject>> executeWithHttpInfo() throws ApiException {
            return configurationsGetWithHttpInfo();
        }

        /**
         * Execute configurationsGet request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<CodeObject>> _callback) throws ApiException {
            return configurationsGetAsync(_callback);
        }
    }
     ...
     * @return ConfigurationsGetRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
     ...
     */
    public ConfigurationsGetRequestBuilder configurationsGet() throws IllegalArgumentException {
        return new ConfigurationsGetRequestBuilder();
    }
    ...
    public class CreateConfigurationRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> The allergy provided has been created. </td><td>  -  </td></tr>
            <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
     ...
     * @param codeObject The allergy code to be written. (required)
    ...
    private okhttp3.Call updateSingleConfigurationCall(String code, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/allergy/{code}"
