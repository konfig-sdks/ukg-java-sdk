...
public class EmployeeTypeApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public EmployeeTypeApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public EmployeeTypeApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createConfigurationUkgProCall(CodeObject codeObject, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/employeeType";
    ...
    public class CreateConfigurationUkgProRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> The employeeType provided has been created. </td><td>  -  </td></tr>
     ...
     * @param codeObject The employeeType code to be written. (required)
    ...
    private okhttp3.Call updateConfigurationCall(String code, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/employeeType/{code}"
