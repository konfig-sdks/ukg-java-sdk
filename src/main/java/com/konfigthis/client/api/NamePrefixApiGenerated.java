...
public class NamePrefixApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public NamePrefixApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public NamePrefixApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call configureNamePrefixCall(CodeObject codeObject, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/namePrefix";
    ...
    private okhttp3.Call configureNamePrefixValidateBeforeCall(CodeObject codeObject, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'codeObject' is set
        if (codeObject == null) {
            throw new ApiException("Missing the required parameter 'codeObject' when calling configureNamePrefix(Async)");
        }

        return configureNamePrefixCall(codeObject, _callback);

    }


    private ApiResponse<Void> configureNamePrefixWithHttpInfo(CodeObject codeObject) throws ApiException {
        okhttp3.Call localVarCall = configureNamePrefixValidateBeforeCall(codeObject, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call configureNamePrefixAsync(CodeObject codeObject, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = configureNamePrefixValidateBeforeCall(codeObject, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class ConfigureNamePrefixRequestBuilder {
        private final String description;
        private final String code;

        private ConfigureNamePrefixRequestBuilder(String description, String code) {
            this.description = description;
            this.code = code;
        }

        /**
         * Build call for configureNamePrefix
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> The namePrefix provided has been created. </td><td>  -  </td></tr>
        ...
        /**
         * Execute configureNamePrefix request
        ...
        public void execute() throws ApiException {
            CodeObject codeObject = buildBodyParams();
            configureNamePrefixWithHttpInfo(codeObject);
        }

        /**
         * Execute configureNamePrefix request with HTTP info returned
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            CodeObject codeObject = buildBodyParams();
            return configureNamePrefixWithHttpInfo(codeObject);
        }

        /**
         * Execute configureNamePrefix request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            CodeObject codeObject = buildBodyParams();
            return configureNamePrefixAsync(codeObject, _callback);
        }
    }
     ...
     * @param codeObject The namePrefix code to be written. (required)
     * @return ConfigureNamePrefixRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The namePrefix provided has been created. </td><td>  -  </td></tr>
     ...
     */
    public ConfigureNamePrefixRequestBuilder configureNamePrefix(String description, String code) throws IllegalArgumentException {
        ...
        return new ConfigureNamePrefixRequestBuilder(description, code);
    }
    ...
    private okhttp3.Call updateConfigurationCall(String code, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/namePrefix/{code}"
