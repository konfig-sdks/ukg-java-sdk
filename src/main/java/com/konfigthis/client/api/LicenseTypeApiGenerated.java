...
public class LicenseTypeApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public LicenseTypeApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public LicenseTypeApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createConfigurationCall(CodeObject codeObject, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/licenseType";
    ...
    public class CreateConfigurationRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> The licenseType provided has been created. </td><td>  -  </td></tr>
     ...
     * @param codeObject The licenseType code to be written. (required)
    ...
    private okhttp3.Call updateConfigurationCall(String code, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/licenseType/{code}"
