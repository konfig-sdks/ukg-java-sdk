...
public class SkillProficiencyLevelApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SkillProficiencyLevelApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public SkillProficiencyLevelApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createConfigurationUkgProCall(CodeObject codeObject, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/skillProficiencyLevel";
    ...
    public class CreateConfigurationUkgProRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> The skillProficiencyLevel provided has been created. </td><td>  -  </td></tr>
     ...
     * @param codeObject The skillProficiencyLevel code to be written. (required)
    ...
    private okhttp3.Call updateConfigurationCall(String code, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/skillProficiencyLevel/{code}"
