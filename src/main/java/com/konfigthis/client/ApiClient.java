...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "http://http:";
    private String tokenUrl = "https://identity.mia.ucloud.int/t/ulticonnect/token";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("basicAuth", new ApiKeyAuth("header", "US-CUSTOMER-API-KEY"));
        ...
        if (configuration != null) {
            if (configuration.basicAuth != null) {
                this.setBasicAuth(configuration.basicAuth);
            }
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("OauthSecurity", oauth);
        return oauth;
    }

    public String getBasicAuth() {
        return ((ApiKeyAuth) this.getAuthentication("basicAuth")).getApiKey();
    }

    public void setBasicAuth(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("basicAuth")).setApiKey(apiKey);
    }

    public void setBasicAuthPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("basicAuth")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://http:)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://identity.mia.ucloud.int/t/ulticonnect/token)
     * @return An instance of OkHttpClient
     */
